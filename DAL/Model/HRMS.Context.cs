...
namespace DAL.Model
{
    ...
    public partial class dbHRMSEntities : DbContext
    {
        ...
        public virtual int sp_AddLeave(Nullable<int> empId, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, string leaveType, string leaveReason)
        {
            var empIdParameter = empId.HasValue ?
                new ObjectParameter("EmpId", empId) :
                new ObjectParameter("EmpId", typeof(int));
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_AddLeave", empIdParameter, fromDateParameter, toDateParameter, leaveTypeParameter, leaveReasonParameter);
        }
    
        public virtual int sp_DeleteLeaveDetails(Nullable<int> leaveId)
        {
            var leaveIdParameter = leaveId.HasValue ?
                new ObjectParameter("LeaveId", leaveId) :
                new ObjectParameter("LeaveId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("sp_DeleteLeaveDetails", leaveIdParameter);
        }
    
        public virtual ObjectResult<sp_GetLeaveDetailsByLeaveId_Result> sp_GetLeaveDetailsByLeaveId(Nullable<int> leaveId)
        {
            var leaveIdParameter = leaveId.HasValue ?
                new ObjectParameter("LeaveId", leaveId) :
                new ObjectParameter("LeaveId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_GetLeaveDetailsByLeaveId_Result>("sp_GetLeaveDetailsByLeaveId", leaveIdParameter);
        }
    
        public virtual ObjectResult<sp_GetLeaveListByEmpId_Result> sp_GetLeaveListByEmpId(Nullable<int> empId)
        {
            var empIdParameter = empId.HasValue ?
                new ObjectParameter("EmpId", empId) :
                new ObjectParameter("EmpId", typeof(int));
    
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction<sp_GetLeaveListByEmpId_Result>("sp_GetLeaveListByEmpId", empIdParameter);
        }
    
        public virtual int sp_UpdateLeaveDetails(Nullable<int> leaveId, Nullable<int> empId, Nullable<System.DateTime> fromDate, Nullable<System.DateTime> toDate, string leaveType, string leaveReason)
        {
            var leaveIdParameter = leaveId.HasValue ?
                new ObjectParameter("LeaveId", leaveId) :
                new ObjectParameter("LeaveId", typeof(int));
